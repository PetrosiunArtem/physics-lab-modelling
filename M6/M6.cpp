        ...
        while (time_to_integrate > 0) {
            ...
            for (int x = 0; x < std::ssize(points); ++x) {
                for (int y = 0; y < std::ssize(points[x]); ++y) {
                    ...
                    const double GOOK_COEF = 10000.0;

                    if (x + 1 < std::ssize(points)) {
                        points[x][y].accel.x +=
                            GOOK_COEF * (points[x + 1][y].pos.x -
            ...
            for (int x = 0; x < std::ssize(points); ++x) {
                for (int y = 0; y < std::ssize(points[x]); ++y) {
                    ...
                    if (points[x][y].pos.x > horizontal_border) {
                        points[x][y].pos.x = horizontal_border;
                    }
                    ...
                    if (points[x][y].pos.y > vertical_border) {
                        points[x][y].pos.y = vertical_border;
                    }
